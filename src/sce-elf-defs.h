...
typedef struct SCE_TYPE(sce_module_info) {
	...
	SCE_PTR(int32_t    *) process_param_main_thread_priority;
	SCE_PTR(uint32_t   *) process_param_main_thread_stacksize;
	 ...
	 */
	SCE_PTR(uint32_t   *) process_param_process_preload_disabled;
